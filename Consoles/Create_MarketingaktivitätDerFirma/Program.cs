...
namespace Create_MarketingaktivitätDerFirma
{
        ...
        static void Main(string[] args)
        {
            using (ServiceClient serviceClient = new ServiceClient(connectionString))
            {
                if (serviceClient.IsReady)
                {
                    ...
                    {
                        ColumnSet = new ColumnSet("accountid", "name", "bit_easytrinkwasser",
                        "bit_easyosterzeit", "bit_easymobil", "bit_easyhautrein", "bit_easybauchgefhl", "bit_easyeingepackt",
                        "bit_easysparwochen", "bit_easysparlender", "bit_taschenkalender", "bit_easybescherung", "bit_easyvmpos", "bit_easyeinseifen", "bit_easysommerzeit", "bit_schokokalender"),
                        Criteria = {
                    ...
                    string[] arrAtribute = { "bit_easytrinkwasser", "bit_easyosterzeit", "bit_easymobil", "bit_easyhautrein", "bit_easybauchgefhl", 
                                             "bit_easyeingepackt", "bit_easysparwochen", "bit_easysparlender", "bit_taschenkalender", "bit_easybescherung", 
                                             "bit_easyvmpos", "bit_easyeinseifen", "bit_schokokalender", "bit_easysommerzeit"};
                    ...
                    foreach (var account in accounts)
                    {
                        ...
                        foreach (var atr in arrAtribute)
                        {
                            ...
                            {
                                ["bit_name"] = accountNameShort + "|" + atr.Replace("bit_", "") + "|2023",
                                ...
                                ["bit_startdate"] = new DateTime(2023, 01, 01),
                            };
